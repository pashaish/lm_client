...
// };
// use iced::widget::{column, container, row, rule, scrollable, span, text};
// use url::Url;
// use crate::overrides::rich::rich_text;
// use crate::overrides::table;
...
//                 .width(settings.code_size.0 / 2.0)
//                 .scroller_width(settings.code_size.0 / 2.0),
//         )),
//     )
//     .width(Length::Fill)
...
//     let table = crate::overrides::table::table(
...
// pub trait Viewer<'a, Message, Theme = crate::Theme, Renderer = iced::Renderer>
// where
//     Self: Sized + 'a,
//     Message: 'a,
//     Theme: Catalog + 'a,
