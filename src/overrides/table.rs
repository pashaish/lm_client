...
// use iced::widget;
// use iced::{
//     Alignment, Background, Element, Length, Pixels, Rectangle, Size,
// };
...
// pub struct Table<'a, Message, Theme = crate::Theme, Renderer = iced::Renderer>
// where
//     Theme: Catalog,
// {
//     columns: Vec<Column_>,
...
//         iced::advanced::widget::tree::Tag::of::<Metrics>()
//     }

//     fn state(&self) -> iced::advanced::widget::tree::State {
//         iced::advanced::widget::tree::State::new(Metrics {
//             columns: Vec::new(),
//             rows: Vec::new(),
//         })
//     }
...
//         self.cells
//             .iter()
//             .map(|cell| iced::advanced::widget::tree::Tree::new(cell.as_widget()))
//             .collect()
//     }

//     fn diff(&self, state: &mut iced::advanced::widget::tree::Tree) {
...
//     // fn _overlay<'b>(
//     //     &'b mut self,
//     //     state: &'b mut iced::advanced::widget::tree::Tree,
//     //     layout: Layout<'b>,
//     //     renderer: &Renderer,
//     //     viewport: &Rectangle,
